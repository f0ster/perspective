...
export class PerspectiveElement extends StateElement {
    ...
    async _new_view({force_update = false, ignore_size_check = false, limit_points = true} = {}) {
        ...
        try {
            ...
            // if this._view is undefined, calling delete will throw its own
            // "cannot read property of undefined" error and squash the
            // original, more informative error message on why the view
