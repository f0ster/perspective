...
function drawChart(chart) {
    return async function(el, view, task, end_col, end_row) {
        ...
        let [table_schema, expression_schema, view_schema, json, config] = await Promise.all([this._table.schema(false), view.expression_schema(false), view.schema(false), jsonp, view.get_config()]);
